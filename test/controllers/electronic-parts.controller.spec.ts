...
describe('Electronic Parts Controller', () => {
  ...
  it('should get bestsellers', async () => {
    ...
    const response = await request(app.getHttpServer())
      .get('/electronic-parts/bestsellers')
      .set('Cookie', login.headers['set-cookie']);
  ...
  it('should search by string', async () => {
    const body = { search: 'ai' };
    const login = await request(app.getHttpServer())
      .post('/users/login')
      .send({ username: mockedUser.username, password: mockedUser.password });

    const response = await request(app.getHttpServer())
      .post('/electronic-parts/search')
      .send(body)
      .set('Cookie', login.headers['set-cookie']);
  ...
  it('should get by name', async () => {
    const body = { name: 'Samsung' };
    const login = await request(app.getHttpServer())
      .post('/users/login')
      .send({ username: mockedUser.username, password: mockedUser.password });

    const response = await request(app.getHttpServer())
      .post('/electronic-parts/name')
      .send(body)
      .set('Cookie', login.headers['set-cookie']);
